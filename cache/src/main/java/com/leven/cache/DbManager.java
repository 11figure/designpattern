...
/**
 *
 * <p>DBManager handles the communication with the underlying com.leven.data store i.e. Database. It contains the
 * implemented methods for querying, inserting, and updating com.leven.data. MongoDB was used as the database
 * for the application.</p>
 *
 * <p>Developer/Tester is able to choose whether the application should use MongoDB as its underlying
 * com.leven.data storage (connect()) or a simple Java com.leven.data structure to (temporarily) store the com.leven.data/objects
...
public final class DbManager {
    ...
    /**
     *
     * Insert com.leven.data into DB if it does not exist. Else, update it.
     */
